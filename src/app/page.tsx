...
export default function Home() {
  ...
  const [topIdeas, setTopIdeas] = useState<IdeaCard[]>([]);
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    ...
                    <div className="text-base font-semibold text-zinc-900 dark:text-zinc-50">{idea.title}</div>
                  </div>
                  {idea.isPaid ? (
                ...
                <div className="mt-4 flex items-center justify-between text-xs text-zinc-600 dark:text-zinc-400">
                  <div>
                    Score: <span className="font-semibold text-zinc-900 dark:text-zinc-100">{idea.voteScore}</span>
                  </div>
                  <div className="font-medium">
                    {idea.isPaid && idea.hasAccess === false ? "Locked" : "View Idea"}
                  </div>
                </div>
              </Link>
            ))}
